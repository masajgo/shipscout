...
const VESSELS = [
  {
    imo: "9811000", name: "EVER GIVEN", flag: "Panama",
    type: "Container", built: 2018, dwt: 199692, ldt: 42000,
    location: "Suez Canal", score: 45, status: "AIS Dark",
    statusType: "b", estValue: "$21.4M", market: "Alang", deadline: null,
  },
  {
    imo: "9395044", name: "MSC FLAMINIA", flag: "Liberia",
    type: "Container", built: 2001, dwt: 81000, ldt: 18000,
    location: "Bremerhaven", score: 72, status: "Survey Due",
    statusType: "a", estValue: "$9.2M", market: "Chittagong", deadline: null,
  },
  {
    imo: "9134261", name: "PRESTIGE", flag: "Bahamas",
    type: "Tanker", built: 1976, dwt: 77000, ldt: 14200,
    location: "Atlantic", score: 88, status: "Detained",
    statusType: "r", estValue: "$7.2M", market: "Alang", deadline: null,
  },
  {
    imo: "9076695", name: "ERIKA", flag: "Malta",
    type: "Tanker", built: 1975, dwt: 37283, ldt: 8900,
    location: "Bay of Biscay", score: 91, status: "P&I Withdrawn",
    statusType: "r", estValue: "$4.5M", market: "Gadani", deadline: null,
  },
  {
    imo: "9164990", name: "FEDRA", flag: "Cambodia",
    type: "Bulk Carrier", built: 1997, dwt: 37000, ldt: 8100,
    location: "Karachi", score: 78, status: "Lay-up",
    statusType: "a", estValue: "$4.1M", market: "Gadani", deadline: null,
  },
  {
    imo: "9105688", name: "BULK JUPITER", flag: "Panama",
    type: "Bulk Carrier", built: 1995, dwt: 56000, ldt: 11200,
    location: "South China Sea", score: 83, status: "AIS Dark",
    statusType: "b", estValue: "$6.3M", market: "Alang", deadline: null,
  },
];
