...
export async function GET(req: NextRequest) {
  ...
  const SELECT = `
    ...
    v.age, v.deadweight, v.ldt, v.ldt_estimated, v.gross_tonnage,
    v.scrap_score, v.scrap_category,
    v.detention_count, v.deficiency_count, v.special_survey_date,
    v.callsign, v.home_port, v.teu,
    v.length, v.beam, v.draught,
    v.speed, v.course, v.nav_status, v.destination, v.eta,
    v.last_pos_update, v.last_static_update,
    v.dry_dock_date, v.last_dry_dock_date, v.iopp_exp_date,
    v.last_inspection_date, v.inspection_count,
    ...
    o.ism_manager, o.address, o.country AS company_country, o.company_type,
    o.fleet_count, o.fleet_avg_age, o.fleet_total_dwt,
    o.fleet_critical_count, o.fleet_high_count,
    o.beneficial_owner_imo, o.manager_imo,
    ...
    return NextResponse.json({
      ...
      results: rows.map(r => {
        ...
        return {
          ...
          companyAddress:     r.address        || null,
          companyCountry:     r.company_country|| null,
          companyType:        r.company_type   || null,
          fleetCount:         r.fleet_count    ?? null,
          fleetAvgAge:        r.fleet_avg_age  ?? null,
          fleetTotalDwt:      r.fleet_total_dwt?? null,
          fleetCritical:      r.fleet_critical_count ?? null,
          beneficialOwnerImo: r.beneficial_owner_imo || null,
          // vessel details
          ...
          navStatus:          r.nav_status     ?? null,
          destination:        r.destination    || null,
          eta:                r.eta            || null,
          lastPosUpdate:      r.last_pos_update|| null,
          // certificates / surveys
          dryDockDate:        r.dry_dock_date       || null,
          lastDryDockDate:    r.last_dry_dock_date  || null,
          ioppExpDate:        r.iopp_exp_date       || null,
          lastInspectionDate: r.last_inspection_date|| null,
          inspectionCount:    r.inspection_count    ?? null,
