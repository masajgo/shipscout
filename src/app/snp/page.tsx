...
const LISTINGS = [
  {
    id: 1, name: "MV OCEAN ATLAS", flag: "Panama", imo: "9187432",
    type: "Bulk Carrier", group: "Dry Cargo",
    built: 2001, dwt: 42500, ldt: 8200, location: "Rotterdam",
    price: "$3.8M", priceType: "Reserve",
    saleType: "judicial",
    tags: [{ label: "Auction Jun 18", type: "urgent" }, { label: "Judicial", type: "judicial" }],
    urgent: true,
  },
  {
    id: 2, name: "MT SILVER CAPE", flag: "Togo", imo: "8811247",
    type: "Oil / Crude Tanker", group: "Tankers",
    built: 1995, dwt: 58000, ldt: 11400, location: "Fujairah",
    price: "On Request", priceType: "Negotiable",
    saleType: "bank",
    tags: [{ label: "Bank Repo", type: "bank" }, { label: "P&I Withdrawn", type: "urgent" }],
    urgent: true,
  },
  {
    id: 3, name: "MV PEARL OF ASIA", flag: "Belize", imo: "9234891",
    type: "Bulk Carrier", group: "Dry Cargo",
    built: 2000, dwt: 38000, ldt: 7600, location: "Singapore anchorage",
    price: "$4.1M", priceType: "Asking",
    saleType: "distressed",
    tags: [{ label: "94d idle", type: "idle" }, { label: "Motivated seller", type: "motivated" }],
    urgent: false,
  },
  {
    id: 4, name: "MS ADRIATIC STAR", flag: "Greece", imo: "9067821",
    type: "Cruise Ship", group: "Passenger",
    built: 1998, dwt: null, ldt: 9800, location: "Piraeus",
    price: "$4.5M", priceType: "Asking",
    saleType: "voluntary",
    tags: [{ label: "Motivated seller", type: "motivated" }, { label: "Price reduced", type: "reduced" }],
    urgent: false,
  },
  {
    id: 5, name: "MV PACIFIC BRIDGE", flag: "Marshall Islands", imo: "9423156",
    type: "Container Ship", group: "Dry Cargo",
    built: 2008, dwt: 28000, ldt: 5400, location: "Singapore",
    price: "$7.2M", priceType: "Asking",
    saleType: "voluntary",
    tags: [{ label: "New listing", type: "new" }],
    urgent: false,
  },
  {
    id: 6, name: "MV NORDIC STAR", flag: "Norway", imo: "9312456",
    type: "Offshore Supply (PSV)", group: "Offshore & Special",
    built: 2006, dwt: 4200, ldt: 2100, location: "Bergen",
    price: "$3.2M", priceType: "Asking",
    saleType: "bank",
    tags: [{ label: "Bank Repo", type: "bank" }],
    urgent: false,
  },
];
